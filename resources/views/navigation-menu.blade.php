            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        {{-- Componente para renderizar el logo @linea:10 --}}
                ...
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('registro.clientes') }}" :active="request()->routeIs('registro.clientes')">
                        {{ __('Clientes') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('registro.sanitizaciones') }}" :active="request()->routeIs('registro.sanitizaciones')">
                        {{ __('Sanitizaciones') }}
                    </x-jet-nav-link>
                </div> --}}
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('table.sanitizaciones') }}" :active="request()->routeIs('table.sanitizaciones')">
                        {{ __('Sanitizaciones') }}
                    </x-jet-nav-link>
                </div>
            </div>
